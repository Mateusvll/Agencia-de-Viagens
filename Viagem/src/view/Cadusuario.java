    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Cadusuario.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Cadusuario.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Cadusuario.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Cadusuario.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new Cadusuario());
